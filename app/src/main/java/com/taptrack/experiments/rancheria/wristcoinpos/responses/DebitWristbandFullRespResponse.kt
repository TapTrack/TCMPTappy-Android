...
import com.taptrack.experiments.rancheria.wristcoinpos.type_card_aeon_count
import com.taptrack.experiments.rancheria.wristcoinpos.type_card_closeout_count
import com.taptrack.experiments.rancheria.wristcoinpos.type_card_debit_total
import com.taptrack.experiments.rancheria.wristcoinpos.type_card_reversal_decision_count
import com.taptrack.experiments.rancheria.wristcoinpos.type_card_reversal_total
import com.taptrack.experiments.rancheria.wristcoinpos.type_card_tag_code
import com.taptrack.experiments.rancheria.wristcoinpos.type_card_version
import com.taptrack.experiments.rancheria.wristcoinpos.type_online_topup_amount
import com.taptrack.experiments.rancheria.wristcoinpos.type_preloaded_credit_amount
import com.taptrack.experiments.rancheria.wristcoinpos.type_preloaded_points_amount
import com.taptrack.experiments.rancheria.wristcoinpos.type_reversal_request_count
import com.taptrack.experiments.rancheria.wristcoinpos.type_reward_credit_total
import com.taptrack.experiments.rancheria.wristcoinpos.type_reward_debit_total
import com.taptrack.kotlin_tlv.*
import com.taptrack.tcmptappy2.TCMPMessageParseException

internal class DebitWristbandFullRespResponse : AbstractWristCoinPOSMessage {

...
class NdefMessageWrittenResponseTest {
    @Test
    @Throws(Exception::class)
    fun testGetCommandCode() {
        val command = NdefMessageWrittenResponse()
        Assert.assertEquals(command.commandCode, 0x0B.toByte())
    }
    ...
    fun testPayload() {
        ...
        val response = NdefMessageWrittenResponse(payload)

...
public class ActivateBuzzerForDurationCommand extends AbstractSystemMessage {
    public static final byte COMMAND_CODE = (byte)0x15;
    private int duration;

    public ActivateBuzzerForDurationCommand() {
        this.duration = 0;
    }

    public ActivateBuzzerForDurationCommand(int duration) {

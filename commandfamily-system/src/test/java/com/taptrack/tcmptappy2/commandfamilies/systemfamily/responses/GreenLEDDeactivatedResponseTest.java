...
public class GreenLEDDeactivatedResponseTest {
    ...
    public void testParsePayload() throws Exception {
        ...
        GreenLEDDeactivatedResponse response = new GreenLEDDeactivatedResponse();
    ...
    public void testGetCommandCode() throws Exception {
        GreenLEDDeactivatedResponse response = new GreenLEDDeactivatedResponse();
        assertEquals(response.getCommandCode(),0x11);
    }
}
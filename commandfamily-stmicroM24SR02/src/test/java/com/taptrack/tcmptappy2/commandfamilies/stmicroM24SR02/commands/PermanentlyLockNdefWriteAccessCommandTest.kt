...
class PermanentlyLockNdefWriteAccessCommandTest {
    @Test
    @Throws(Exception::class)
    fun testGetCommandCode() {
        val command = PermanentlyLockNdefWriteAccessCommand()
    ...
    fun testPayload() {
        ...
        val command = PermanentlyLockNdefWriteAccessCommand(payload)
    ...
    fun testLogicalParameters() {
        ...
        val command = PermanentlyLockNdefWriteAccessCommand(timeout, password)
        Assert.assertArrayEquals(command.payload, payload)
        Assert.assertEquals(command.timeout, timeout)

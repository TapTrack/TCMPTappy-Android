 ...
 */
public class DetectActiveHCETargetMultiModeWithoutRequestingInitialCommandCommand extends AbstractType4Message {
    public static final byte COMMAND_CODE = (byte) 0x08;
    private byte timeout;

    public DetectActiveHCETargetMultiModeWithoutRequestingInitialCommandCommand() {
        this.timeout = 0;
    }

    public DetectActiveHCETargetMultiModeWithoutRequestingInitialCommandCommand(byte timeout) {

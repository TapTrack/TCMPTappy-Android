...
public class AutoPollTagExitedResponseTest {
    ...
    public void testParsePayload() throws Exception {
        byte tagType = AutoPollingConstants.ResponseTagTypes.FELICIA;
    ...
    public void testGetPayload() throws Exception {
        byte tagType = AutoPollingConstants.ResponseTagTypes.UNRECOGNIZED_TYPE;
